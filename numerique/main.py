...
if __name__ == "__main__":
    ...
    F, A1, A1err, A2, A2err, seuil_far, seuil_farerr, seuil_co, seuil_coerr = get_datas()
    
    popt, pcov = curve_fit(loi, F, seuil_far)
    Y = loi(F, popt[0], popt[1])
    th = loi(F, 21e-3, 20e-6)

    plot_all(F, A1, A1err, A2, A2err, seuil_far, seuil_farerr, seuil_co, seuil_coerr, Y, th)
